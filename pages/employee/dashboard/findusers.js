...
export default function FindUser({ data }) {
  ...
  export async function getServerSideProps({ query }) {
    ...
    try {
    // const response = await axios.get('http://localhost:3000/employee/findEmployeeById/'+inputValue);
    const response = await axios.get('http://localhost:3000/employee/findemployee/'+inputValue);
