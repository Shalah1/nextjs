...
//          <li>
//             <Link href="/employee/dashboard/addemployee2" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
...
// </svg>
//                <span className="flex-1 ml-3 whitespace-nowrap">Add Employee2</span>
//            </Link>
//          </li>
//          <li>
//             <Link href="/employee/dashboard/findusers" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
...
//          </li>
//          <li>
//             <Link href="/employee/dashboard/getusers" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
