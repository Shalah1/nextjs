...
export default function UserLayoutD({data}) {
    console.log("fetch : ")
console.log(data)
...
<span className="mb-1 text-xl font-medium text-gray-900 dark:text-white">NameD : {data?.nameD}</span>
{/* <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">email : {data?.email}</h5> */}
