...
export default function UserLayoutP({data}) {
    console.log("fetch : ")
console.log(data)
...
<span className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Namep : {data?.namep}</span>
<h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">ProductDescription : {data?.ProductDescription}</h5>
<span className="text-sm text-gray-500 dark:text-gray-400">ProductCategory: {data?.ProductCategory}</span>
<span className="text-sm text-gray-500 dark:text-gray-400">ProductPrice: {data?.ProductPrice}</span>
<span className="text-sm text-gray-500 dark:text-gray-400">Password: {data?.Password}</span>
<span className="mb-1 text-xl font-medium text-gray-900 dark:text-white">ProductAvailability : {data?.ProductAvailability}</span>       
{/* <span className="text-sm text-gray-500 dark:text-gray-400">address: {data?.address}</span> */}
<span className="text-sm text-gray-500 dark:text-gray-400">Productreviews: {data?.Productreviews}</span>
